#!/usr/bin/env python3
"""
Generate video for validated Seg08 image using Kling AI 2.6.
"""
...
def generate_video(image_url, output_path, api_key):
    ...
    payload = {
        ...
        "input": {
            ...
            "prompt": "Charizard recovering mid-air, shaking off electric sparks, teal wings beating powerfully to regain altitude, ascending flight showing determination and resilience, dramatic upward motion, cinematic camera",
            "duration": "5",
            "sound": False
        }
    }
...
def main():
    print("="*70)
    print("SEG08 VIDEO GENERATION FROM VALIDATED IMAGE")
    print("="*70)

    api_key = load_api_key()

    image_path = "charizard/battle_assets/frame_pairs/seg08_continuous_start.jpg"
    output_path = "charizard/battle_assets/videos/seg08_aerial_recovery.mp4"
    ...
    if success:
        print(f"\n{'='*70}")
        print("🎉 SEG08 VIDEO GENERATION COMPLETE!")
        print(f"{'='*70}")
