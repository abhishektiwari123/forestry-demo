#!/usr/bin/env python3
"""
Generate video for validated Seg03 v2 image using Kling AI 2.6.
"""
...
def generate_video(image_url, output_path, api_key):
    ...
    payload = {
        ...
        "input": {
            ...
            "prompt": "Epic dramatic face-off: Dragonite descends from stormy sky toward Charizard on ground, lightning flashes, both Pokemon ready for battle, intense confrontation, cinematic camera",
            "duration": "5",
            "sound": False
        }
    }
...
def main():
    print("="*70)
    print("SEG03 VIDEO GENERATION FROM VALIDATED IMAGE")
    print("="*70)

    api_key = load_api_key()

    image_path = "charizard/battle_assets/frame_pairs/seg03_continuous_start_v2.jpg"
    output_path = "charizard/battle_assets/videos/seg03_compare_kling_v2.mp4"
    ...
    if success:
        print(f"\n{'='*70}")
        print("🎉 SEG03 VIDEO GENERATION COMPLETE!")
        print(f"{'='*70}")
